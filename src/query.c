...
enum key {
    ...
    KEY_UUID,
    KEY_CASCADE,
    KEY_BOOK_FILTER_BY_SERIALNUM,
    KEY_BOOK_FILTER_BY_LANG_ID,
    KEY_BOOK_FILTER_BY_TYPE_ID,
    KEY_BOOK_FILTER_BY_CATEGORY_ID,
    KEY_BOOK_FILTER_BY_AUTHOR_ID,
    KEY_BOOK_FILTER_BY_PUBLISHER_ID,
    KEY_BOOK_FILTER_BY_TITLE,
    KEY_BOOK_FILTER_BY_RELEASE_DATE,
    KEY_BOOK_FILTER_BY_LOWER_DATE,
    KEY_BOOK_FILTER_BY_UPPER_DATE,
    KEY__MAX
};
