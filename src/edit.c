...
static const struct kvalid keys[KEY__MAX] = {
    ...
    {kvalid_stringne, "mod_frozen"},
    {kvalid_stringne, "mod_serialnum"},
    {kvalid_stringne, "mod_type"},
    {kvalid_stringne, "mod_category"},
    {kvalid_stringne, "mod_publisher"},
    {kvalid_stringne, "mod_year"},
    {kvalid_stringne, "mod_cover"},
    {kvalid_stringne, "mod_hits"},
    {kvalid_stringne, "mod_lang"},
    {kvalid_stringne, "mod_author"},
    {kvalid_stringne, "mod_stock"},
    {kvalid_stringne, "mod_duration"},
    {kvalid_stringne, "mod_date"},
    {kvalid_stringne, "mod_extended"},
};
