...
all: build/hit build/add build/edit build/query build/auth build/deauth build/signup build/search build/database.db build/me
install:install-me install-hit install-edit install-add install-auth install-deauth install-query install-signup install-search install-db
